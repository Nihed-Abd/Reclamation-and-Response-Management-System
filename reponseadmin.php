...
<body>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="http://localhost/reclamation/admin.php" class="nav-item nav-link "><i class="fa fa-table me-2"></i>Réclamations</a>
                        <a href="http://localhost/reclamation/reponseadmin.php" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Réponses</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
    ...
    <script src="admin/darkpan-1.0.0/js/main.js"></script>
            ...
            <div class="form-group">
                <a href="../reclamation/addreponse.php">
